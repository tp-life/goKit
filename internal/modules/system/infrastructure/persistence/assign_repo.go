...
func NewAssignRepository(client *db.Client) repository.AssignRepository {
...
func (r *assignRepo) SetUserRoles(ctx context.Context, userID uint64, roleIDs []uint64) error {
	return r.setRelations(ctx, &entity.UserRole{}, "sys_user_roles", "user_id", "role_id", userID, roleIDs)
}
...
func (r *assignRepo) SetRoleMenus(ctx context.Context, roleID uint64, menuIDs []uint64) error {
	return r.setRelations(ctx, &entity.RoleMenu{}, "sys_role_menus", "role_id", "menu_id", roleID, menuIDs)
}
...
func (r *assignRepo) SetRoleDepts(ctx context.Context, roleID uint64, deptIDs []uint64) error {
	return r.setRelations(ctx, &entity.RoleDept{}, "sys_role_depts", "role_id", "dept_id", roleID, deptIDs)
}
...
func (r *assignRepo) SetRoleUsers(ctx context.Context, roleID uint64, userIDs []uint64) error {
	return r.setRelations(ctx, &entity.UserRole{}, "sys_user_roles", "role_id", "user_id", roleID, userIDs)
}
