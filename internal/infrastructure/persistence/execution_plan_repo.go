	...
	return r.client.WithTx(ctx, func(ctx context.Context) error {
		...
		return r.client.GetDB(ctx).Clauses(clause.OnConflict{
			...
			DoUpdates: clause.AssignmentColumns([]string{
				...
				"long_funding_event_count", "short_funding_event_count", "funding_window_hours", "arbitrage_mode", "strategy_mode", "funding_computation_mode",
				"perp_funding_rank", "perp_funding_rank_total", "perp_funding_rank_percentile",
				"perp_funding_history_sample_count", "perp_funding_history_negative_ratio", "perp_funding_history_positive_ratio", "perp_funding_current_historical_percentile",
				"same_exchange_price_risk_allowed", "same_exchange_price_risk_reason", "same_exchange_price_shock_current_mark_price", "same_exchange_price_shock_baseline_mark_price", "same_exchange_price_shock_ratio",
